...
harness: src/fuzzer/harness/harness.c src/fuzzer/harness/harness.h src/fuzzer/harness/hooks.c src/fuzzer/harness/hooks.h src/fuzzer/harness/socket.c src/fuzzer/harness/socket.h
	gcc -O0 -g -m32 -masm="intel" -fPIC -shared -Wl,--no-undefined -rdynamic src/fuzzer/harness/harness.c src/fuzzer/harness/hooks.c src/fuzzer/harness/socket.c -o src/fuzzer/harness/harness.so -ldl
